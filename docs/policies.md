...
| `allowed_login_methods` | []string | Per-user login method overrides (`standard`, `google_oauth`, `saml`); empty when the user follows the organization's default login methods |
